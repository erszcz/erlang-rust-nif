...
/* the rest is automatically generated by rust-bindgen */
...
pub struct Struct_Unnamed10 {
    ...
    pub fptr: ::std::option::Option<extern "C" fn(env: *mut ErlNifEnv,
                                                  argc: ::libc::c_int,
...
pub struct Struct_enif_entry_t {
    ...
    pub load: ::std::option::Option<extern "C" fn(arg1: *mut ErlNifEnv,
                                                  priv_data:
                                                      *mut *mut ::libc::c_void,
                                                  load_info: ERL_NIF_TERM)
                                        -> ::libc::c_int>,
    pub reload: ::std::option::Option<extern "C" fn(arg1: *mut ErlNifEnv,
                                                    priv_data:
                                                        *mut *mut ::libc::c_void,
                                                    load_info: ERL_NIF_TERM)
                                          -> ::libc::c_int>,
    pub upgrade: ::std::option::Option<extern "C" fn(arg1: *mut ErlNifEnv,
                                                     priv_data:
                                                         *mut *mut ::libc::c_void,
                                                     old_priv_data:
                                                         *mut *mut ::libc::c_void,
                                                     load_info: ERL_NIF_TERM)
                                           -> ::libc::c_int>,
    pub unload: ::std::option::Option<extern "C" fn(arg1: *mut ErlNifEnv,
                                                    priv_data:
                                                        *mut ::libc::c_void)
                                          -> ()>,
    pub vm_variant: *const ::libc::c_char,
}
impl ::std::clone::Clone for Struct_enif_entry_t {
    fn clone(&self) -> Self { *self }
}
...
pub struct Struct_Unnamed15 {
    ...
    pub __spare__: [*mut ::libc::c_void; 2usize],
}
